...
// fetch()를 이용하여 서버로 데이터를 전송
  ...
  return (
    ...
    <div style={{width: '100%', height: '100%', position: 'relative', background: 'white',marginLeft:40,marginRight:40,}}>
        
      <div style={{ width: 496, height: 239,textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center' ,marginBottom:10}}>
          <img style={{width: 354, height: 239, left: 0, top: 0, position: 'absolute'}} src={logo} alt=''  onClick={handleLogoClick}/>
      </div>


      <div style={{ display: 'flex',marginRight:40,marginBottom:40 }}>
          <div style={{ width:1102 }}>
              ...
              <div style={{ height: 'auto', opacity: 0.90, background: 'white', borderRadius: 31, border: '3px #3A76EF solid', marginTop: 20, marginBottom: 10, padding: '20px', wordWrap: 'break-word' }}>
                  ...
                  <div style={{  borderRadius: 31 }}>
                      <textarea style={{ color: 'black', fontSize: 40, fontFamily: 'Inter', fontWeight: '400', paddingLeft: '20px', paddingRight: '20px',border: 'none',outline:'none'  }}
                          value={description}
          ...
          <div style={{ marginLeft: 20 }}>
              ...
              <div style={{ width: 491, height: 500, opacity: 0.90, background: 'white', padding: '20px', wordWrap: 'break-word', borderRadius: 31, border: '3px #3A76EF solid', marginTop: 20 }}>
                  <div style={{  borderRadius: 31 }}>
                    <textarea style={{ color: 'black', fontSize: 40, fontFamily: 'Inter', fontWeight: '400', paddingLeft: '20px', paddingRight: '20px',border: 'none',outline:'none'  }}
                      className="profile"
                      value={profile}
      ...
      <div style={{ display: 'flex' , marginRight: 40 }}>
        ...
        <div style={{ width:'50%' }}>
          <div style={{ height: 50, opacity: 0.90, background: '#798BE6', borderRadius: 31,  padding: '20px', wordWrap: 'break-word', cursor: 'pointer', display: 'flex',
      alignItems: 'center', position: 'relative',justifyContent: 'center'}} onClick={handleMenuToggle}>
            {!category && <span className="category-text"  style={{ zIndex: 2, color: 'white', fontSize: '23px',position: 'absolute', }}>카테고리 선택</span>}
        ...
        <div>
            <img  style={{ position: 'absolute', bottom: '10px', right: '10px',}}
            className="c-upload"
            src={c_upload}
            alt=""
