                ...
                <S.Center>                   
                    <S.InLayoutOne>  
                        <S.Content>
                            ...
                            <S.Four>{/* 이미지 */}
                                {!previewImage && (
                                    <S.EmptyImg src={upload} alt="upload" />
                                )} {/*빈 이미지로 사진 올리면 없어짐 */}
                    ...
                    <S.InLayoutTwo>
                        ...
                        <S.Buttons>
                            <S.Left>
                                <S.ButtonOne onClick={handleMenuToggle}> {/*카테고리 */}
                                ...
                                <S.DropContainer>
                                    ...
                                    <S.DropMenu >
                                        {classLabels.map((label, index) => (
                                          <S.CateMenu key={index} onClick={() => handleCategorySelect(label)}>
                                            {label}
                                          </S.CateMenu>
                                        ))}    
                                    </S.DropMenu>
                            ...
                            <S.Right> 
                                <S.ButtonTwo onClick={handleSubmit}>
                                    업로드  
                                </S.ButtonTwo>
                            </S.Right>
                            {/* 성공 메시지를 보여주는 부분 */}
